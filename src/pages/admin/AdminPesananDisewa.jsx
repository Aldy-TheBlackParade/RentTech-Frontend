...
import { allRented, finishOrderById } from "../../service/checkout";

const AdminPesananDisewa = () => {
  ...
  const handleFinishOrder = async (orderId) => {
    const confirmFinish = confirm(
      "Yakin item sudah dikembalikan dan pesanan diselesaikan?"
    );
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-8">
        ...
        <h2 className="text-xl font-semibold mb-4">Pesanan Disewa</h2>
...
export default AdminPesananDisewa;
